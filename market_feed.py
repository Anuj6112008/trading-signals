...
# Shared In-Memory Real-Time Candlestick Storage
_feed_lock = threading.Lock()
candles_live: Dict[str, List[Dict[str, float]]] = {item["symbol"]: [] for item in TARGET_ASSETS}
live_prices: Dict[str, float] = {item["symbol"]: 0.0 for item in TARGET_ASSETS}
_is_streaming: bool = False


def fetch_all_candles() -> None:
    """Fetches real-time M1 historical and forming candles across all target assets."""
